...
describe('favorite blog', () => {
  ...
  test('when list has one blog equals the object', () => {
    const result = listHelper.favoriteBlog(oneBlogList)
    expect(result).toEqual(oneBlogList[0])
  })

  test('of a bigger list is returned right object', () => {
